...
public class AccountDaoImpl implements AccountDao {
	...
	public PageBean getPageBeanByParam(List<String> wheres, List<String> values) {
		...
		AccountDetail accountDetail = null;
		con = DBManager.getConnection();
		String sql = "select a.accountId,g.goodsName,g.goodsNum,a.businessNum,a.totalPrice, a.isPayed,p.providerName,g.goodsIntro,a.accountDate "
				    + "from tb_account a left join tb_goods g on a.goodsId = g.goodsId  left join tb_provider p on p.providerId = a.providerId ";
